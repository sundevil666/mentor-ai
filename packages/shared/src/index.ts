...
export interface ReadingTranscriptChunk {
  ...
  text: string;
  capturedAt: string;
  recognitionEngine: 'device-whisper' | 'cloud-whisper' | 'browser';
}
...
const learningLessonTemplates: LessonTemplate[] = [
  ...
  {
    key: 'weekly-weak-spots-dialogue',
    title: 'Weekly weak spots dialogue',
    exercises: [
      {
        type: 'listening-text',
        prompt: 'Listen to the short beginner dialogue',
        microLesson:
          'This first week targets common beginner weak spots: question order, time prepositions, useful requests, and one natural everyday chunk.',
        successTip: 'Listen once for the story, then replay the sentences that feel slow or unclear.',
        targetSkill: 'listening',
        expectedResponse: 'listened',
        audioText:
          'Mia: What time do you start work today?\nTom: I start at seven, but I need to leave home at six.\nMia: Are you going by bus or by car?\nTom: By bus. Could you send me the address again, please?\nMia: Sure. I also ran into Pavel near the station this morning.\nTom: Nice. I want to ask him about the new schedule later.',
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Во сколько ты сегодня начинаешь работу?',
        microLesson: 'English questions usually need helper + subject + verb: what time do you start.',
        successTip: 'Native answer: What time do you start work today?',
        targetSkill: 'speaking',
      ...
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Я начинаю в семь, но мне нужно выйти из дома в шесть.',
        microLesson: 'Use at for clock time: at seven, at six.',
        successTip: 'Native answer: I start at seven, but I need to leave home at six.',
        targetSkill: 'speaking',
      ...
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Ты едешь на автобусе или на машине?',
        microLesson: 'For transport choices, by bus and by car are short natural chunks.',
        successTip: 'Native answer: Are you going by bus or by car?',
        targetSkill: 'speaking',
      ...
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Можешь отправить мне адрес еще раз, пожалуйста?',
        microLesson: 'Could you is a safe polite request pattern for real conversations.',
        successTip: 'Native answer: Could you send me the address again, please?',
        targetSkill: 'speaking',
      ...
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Я случайно встретил Павла возле станции сегодня утром.',
        microLesson: 'Run into means meet someone by chance. It is included as one natural chunk, not the whole focus.',
        successTip: 'Native answer: I ran into Pavel near the station this morning.',
        targetSkill: 'speaking',
...
const listeningLessonTemplates: LessonTemplate[] = [
  ...
  {
    key: 'shop-listening',
    title: 'Listening: at a small shop',
    exercises: [
      {
        type: 'listening-text',
        prompt: 'Listen to the shop conversation',
        microLesson: 'First listen for the situation. You do not need to understand every word.',
        successTip: 'Listen to the complete dialogue once before answering.',
        targetSkill: 'listening',
        expectedResponse: 'listened',
        audioText:
          'Mia: Good afternoon. Can I help you?\nTom: Yes, please. I need a bottle of water and two apples.\nMia: Of course. Would you like anything else?\nTom: No, thank you. How much is it?\nMia: It is three euros fifty.\nTom: Here you are. Thank you.\nMia: Thank you. Have a nice day!',
      },
      {
        type: 'listening-comprehension',
        ...
        targetSkill: 'listening',
        expectedResponse: 'water and apples',
        options: ['water and apples', 'tea and bread', 'a bus ticket'],
        audioText: 'I need a bottle of water and two apples.',
      },
      {
        type: 'listening-comprehension',
        prompt: 'How much does Tom pay?',
        microLesson: 'Prices often come near the end of a shop conversation.',
        successTip: 'Choose the price you heard after How much is it?',
        targetSkill: 'listening',
        expectedResponse: 'three euros fifty',
        options: ['two euros', 'three euros fifty', 'five euros thirty'],
        audioText: 'It is three euros fifty.',
      },
      {
        type: 'repeat-speaking',
        prompt: 'Repeat Tom’s request: I need a bottle of water and two apples.',
        microLesson: 'Repeating the key sentence turns listening into language you can use.',
        successTip: 'Speak in three chunks: I need / a bottle of water / and two apples.',
        targetSkill: 'speaking',
        expectedResponse: 'i need a bottle of water and two apples',
        audioText: 'I need a bottle of water and two apples.',
      },
    ],
  },
    ...
    exercises: [
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Извините, вы можете мне помочь?',
        microLesson: 'Excuse me gets attention politely; could you makes the request softer.',
        successTip: 'Native answer: Excuse me, could you help me?',
        targetSkill: 'speaking',
        expectedResponse: 'excuse me could you help me',
        audioText: 'Excuse me, could you help me?',
        audioVoice: 'mia',
        phraseFocus: 'polite opening',
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Вы можете повторить, пожалуйста?',
        microLesson: 'This phrase is useful when listening is difficult.',
        successTip: 'Native answer: Could you repeat that, please?',
        targetSkill: 'speaking',
        expectedResponse: 'could you repeat that please',
        audioText: 'Could you repeat that, please?',
        audioVoice: 'tom',
        phraseFocus: 'asking to repeat',
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Не могли бы вы говорить немного медленнее?',
        microLesson: 'A little more slowly is a friendly, specific request.',
        successTip: 'Native answer: Could you speak a little more slowly?',
        targetSkill: 'speaking',
        expectedResponse: 'could you speak a little more slowly',
        audioText: 'Could you speak a little more slowly?',
        audioVoice: 'mia',
        phraseFocus: 'asking for slower speech',
      },
      {
        type: 'dialogue-translation',
        prompt: 'Say it in English',
        nativePrompt: 'Спасибо, теперь я понимаю.',
        microLesson: 'Finish the exchange positively when the other person helps.',
        successTip: 'Native answer: Thank you, I understand now.',
        targetSkill: 'speaking',
        expectedResponse: 'thank you i understand now',
        audioText: 'Thank you, I understand now.',
        audioVoice: 'tom',
        phraseFocus: 'closing the exchange',
      },
    ],
  },
];
